...
var uglify = require('gulp-bookmarkify');

gulp.task('default',function(){
	return gulp.src(['./app/lib/jquery.min.js','./app/lib/angular/angular.js',
	'./app/lib/angular/angular-sanitize.min.js','./app/lib/angular/angular-resource.min.js',
